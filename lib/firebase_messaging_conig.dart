...
void _showNotification(RemoteMessage message) {
  ...
  if (message.notification != null) {
    ...
    NotificationsServices.flutterLocalNotificationsPlugin.show(
        ...
        NotificationDetails(
            ...
            android: AndroidNotificationDetails(
              NotificationsServices.androidChannel.id,
              NotificationsServices.androidChannel.name,
              channelDescription:
                  NotificationsServices.androidChannel.description,
